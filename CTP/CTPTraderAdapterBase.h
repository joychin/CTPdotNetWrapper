...
namespace CTP 
{
	...
	public:
		...
		///批量报单操作请求
		int ReqBatchOrderAction(ThostFtdcInputBatchOrderActionField^ pInputBatchOrderAction, int nRequestID);

		///申请组合录入请求
		int ReqCombActionInsert(ThostFtdcInputCombActionField^ pInputCombAction, int nRequestID);*/
